...
@Test
public void garanteQueNaoDevePermitirSessoesTerminadoDentroDoHorarioDeUmaSessaoJaExistente(){
List<Sessao>sessoes = Arrays.asList(sessaoDasDez);
...
@Test 
public void garanteQueNaoDevaPermitirSessoesIniciandoDentroDoHorarioDeUmaSessaoJaExistente()
{
	List<Sessao>sessoes= Arrays.asList(sessaoDasDez)  ;
	Sessao sessao = new Sessao(sessaoDasDez.getHorario().minusHours(1), rogueOne, sala3D);
	GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
